...
public class ModSmithingTemplateItem extends SmithingTemplateItem {
    ...
    private static final Identifier EMPTY_ARMOR_SLOT_NETHERITE_HELMET_TEXTURE;
    private static final Identifier EMPTY_ARMOR_SLOT_NETHERITE_BOOTS_TEXTURE;
    private static final Identifier EMPTY_ARMOR_SLOT_TURTLE_HELMET;
    ...
    public static List<Identifier> getPrestigeUpgradeEmptyBaseSlotTextures() {
        return List.of(EMPTY_ARMOR_SLOT_NETHERITE_HELMET_TEXTURE, EMPTY_ARMOR_SLOT_CHESTPLATE_TEXTURE, EMPTY_ARMOR_SLOT_LEGGINGS_TEXTURE, EMPTY_ARMOR_SLOT_NETHERITE_BOOTS_TEXTURE, EMPTY_SLOT_SWORD_TEXTURE, EMPTY_SLOT_PICKAXE_TEXTURE, EMPTY_SLOT_AXE_TEXTURE, EMPTY_SLOT_SHOVEL_TEXTURE, EMPTY_SLOT_HOE_TEXTURE);
    }
    ...
    public static List<Identifier> getConduitUpgradeEmptyBaseSlotTextures() {
        return List.of(EMPTY_ARMOR_SLOT_TURTLE_HELMET);
    }
    ...
    static {
        ...
        EMPTY_ARMOR_SLOT_NETHERITE_HELMET_TEXTURE = new Identifier(M08Mod.MOD_ID, "item/empty_armor_slot_netherite_helmet");
        EMPTY_ARMOR_SLOT_NETHERITE_BOOTS_TEXTURE = new Identifier(M08Mod.MOD_ID, "item/empty_armor_slot_netherite_boots");
        EMPTY_ARMOR_SLOT_TURTLE_HELMET = new Identifier(M08Mod.MOD_ID,"item/empty_armor_slot_turtle_helmet");
    }
